...
# ZSH_THEME="cobalt2" + dracula  # https://github.com/wesbos/Cobalt2-iterm
...
plugins=(
	...
	zsh-kubectl-prompt              # https://github.com/superbrothers/zsh-kubectl-prompt (cobalt2 + dracula theme)
)
